...
from noregret.games import SymmetrizedGame, TwoPlayerZeroSumNormalFormGame
...
def main():
    ...
    for name, regret_minimizer_factory in tqdm(
        ...
        regret_minimizer = CartesianProductRegretCircuit(
            [row_regret_minimizer, column_regret_minimizer],
        )
        iterations = []
        ...
        plt.title(f'{name} in self-play (symmetrized)')
